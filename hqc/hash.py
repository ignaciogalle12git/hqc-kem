...
# Separadores de dominio verificados contra symmetric.c del repositorio oficial
# Fuente: HQC_PRNG_DOMAIN=0, HQC_XOF_DOMAIN=1, HQC_G_FCT_DOMAIN=0,
...
def G(data: bytes) -> tuple[bytes, bytes]:
    ...
    return digest[:32], digest[32:]   # K, theta
...
class XOF:
    """SHAKE256 como generador de flujo con semilla."""
    ...
    def get_bytes(self, n: int) -> bytes:
        """Obtener n bytes del flujo pseudoaleatorio."""
